...
1. 安装证书
    ...
    ![安装证书-1](./assets/安装-证书安装-1.png)

2. 选择证书存储位置：本地计算机

    ![安装证书-2](./assets/安装-证书安装-2.png)

3. 选择将证书放入"受信任的根证书颁发机构"

    ![安装证书-3](./assets/安装-证书安装-3.png)
    ![安装证书-4](./assets/安装-证书安装-4.png)

4. 完成安装

    ![安装证书-5](./assets/安装-证书安装-5.png)

## 第二步：安装应用

双击 `.msixbundle` 文件，点击"安装"即可。Windows 会自动选择匹配你设备架构的版本。

![安装应用](./assets/安装-运行安装程序.png)
