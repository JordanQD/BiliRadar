...
public sealed class MockBiliDataProvider : IBiliDataProvider
{
    ...
    {
        return Task.FromResult(new BiliVideoUpdatePage(Array.Empty<BiliVideoUpdate>(), string.Empty, false));
    }
    ...
    {
        return Task.FromResult(new BiliVideoHistoryPage(Array.Empty<BiliVideoUpdate>(), 0, 0, false));
    }
    ...
    {
        return Task.FromResult(new BiliViewLaterPage(Array.Empty<BiliVideoUpdate>(), 0, 2, false));
    }
}
